        ...
        <section id="product" className="md:min-h-screen flex items-center justify-center overflow-hidden py-20">
            <div className="mx-auto px-4">
                ...
                <div className="flex flex-row  md:flex-row gap-2 items-center justify-cnter w-full">
                    <div className="border cursor-pointer items-center w-full my-4 p-4 rounded-lg hover:shadow-lg transition-shadow md:flex-row flex-1 flex flex-col hover:shadow-lg hover:-translate-y-0.5 transition-all gap-3">
                        ...
                        <img src={offer1} alt="Today's Special" className="w-full h-auto rounded-lg object-cover sm:w-1/2 sm:h-48 md:w-1/3" />
                    </div>
                    <div className="border cursor-pointer items-center w-full my-4 p-4 rounded-lg hover:shadow-lg transition-shadow md:flex-row flex-1 flex flex-col hover:shadow-lg hover:-translate-y-0.5 transition-all gap-3">
                        <div className="flex flex-col items-center justify-center">
                        ...
                        <img src={offer2} alt="Combo Packages" className="w-full sm:w-1/2 sm:h-48 h-auto object-cover rounded-lg md:w-1/3" />
                    </div>
                </div>
            </div>
        </section >
